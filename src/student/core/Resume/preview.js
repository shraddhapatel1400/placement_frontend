...
const Preview = () => {
    ...
    const submitWord = (event) => {
        event.preventDefault();
        /* var content = html2canvas(document.querySelector("#cv"),{allowTaint:true, useCORS: true}).then(canvas => {
            document.body.appendChild(canvas)
        });
                            ...
                            <h3>Resume Preview</h3>
                                <ButtonDropdown isOpen={dropdownOpen} toggle={toggle}>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        {/* <DropdownItem onClick={submitWord}>Word</DropdownItem> */}
                                    </DropdownMenu>
                                </ButtonDropdown>
                                    ...
                                    <div id="mainArea">
                                        ...
                                        <section>
                                            <article>
                                                ...
                                                <div class="sectionContent">
                                                    <p>{sumId.map(s=>s.experience)} Year</p>
                                                </div>
                                            </article>
                                            <div class="clear"></div>
                                        </section>
                                        ...
                                        <section>
                                            ...
                                            <div class="sectionContent">
                                                {project.filter(p=>p.student===studentId).map((p,i)=>(
                                                    <article key={i}>
                                                        <h2>{p.title}</h2>
                                                        <p class="subDetails">Technology used : {p.technology}&nbsp;&nbsp;&nbsp;Database : {p.database}</p>
                                                        <p>{p.description}</p>
                                                    </article>
                                                ))}
                                            </div>
